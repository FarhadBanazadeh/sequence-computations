...
ORCID: 0009-0004-7023-0298
GitHub: FarhadBanazadeh/sequence-computations
Files

The original computational materials remain available in this repository:

Research Article (PDF) — Full article in PDF format.
LaTeX Source — Source file of the article.
Data and Code (ZIP) — Computational code and supporting data.
